        ...
        stage('Initialize environment') {
            steps {
                script {
                    ...
                    env.IMAGE_NAME = 'postsmith-hub.kr.ncr.ntruss.com/postsmith-api'
        ...
        stage('Deploy K8s') {
            ...
            steps {
                script {
                    ...
                    k8s.deploy("postsmith-api-app-deploy", "postsmith-api-app", "postsmith-deploy", env.IMAGE_NAME, env.IMAGE_TAG)
